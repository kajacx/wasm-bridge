...
pub fn from_js_value(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let tokens = match derive_input.data {
        ...
        syn::Data::Enum(data) => from_js_value::from_js_value_enum(name, data),
        _ => unimplemented!("Union type should not be generated by wit bindgen"),
    };
...
pub fn to_js_value(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let tokens = match derive_input.data {
        ...
        syn::Data::Enum(data) => to_js_value::to_js_value_enum(name, data),
        _ => unimplemented!("Union type should not be generated by wit bindgen"),
    };
