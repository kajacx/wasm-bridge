...
for test in no_bindgen_wat/*; do
  # create the instance folder if it doesn't exist
  mkdir -p instance

  # copy the "no_bindgen_wat" skeleton
  cp -r skeletons/no_bindgen_wat/plugin ./instance
  cp -r skeletons/no_bindgen_wat/host_sys ./instance
  cp -r skeletons/no_bindgen_wat/host_js ./instance

  # copy the plugin code
  cp $test/plugin.wat instance/plugin/plugin.wat
